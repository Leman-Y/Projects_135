...
// read symbol
// if symbol is carrot, then do math (have variable to save last number added/subtracted, which means last operation should also be stored)
// then, if was carrot, go back to top of loop
// once determined that its a +/_, then read the number, store both in memoory, and do proper operation
